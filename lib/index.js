    ...
    algorithms.forEach(algorithm => {
        switch (algorithm) {
            ...
            case "bcrypt_strongest":
                ...
                break;
            case "blake2b":
                hashed = to_blake2b(hashed);
                break;
            case "crc32":
                hashed = to_crc32(hashed);
                break;
            case "murmurhashv2":
                hashed = to_murmurhash_v2(hashed);
                break;
            case "murmurhashv3":
                hashed = to_murmurhash_v3(hashed);
                break;
            case "xxhash":
                hashed = to_xxhash(hashed);
                break;
            case "keccak":
                hashed = to_keccak(hashed);
                break;
            case "base64":
